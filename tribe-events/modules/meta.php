...
<?php if ( $set_venue_apart ) : ?>
    ...
    <div class="well">
       <div class="row">
            <div class="col-sm-12"><h3 class="tribe-events-single-section-title text-center"> <?php _e( tribe_get_venue_label_singular(), 'tribe-events-calendar' ) ?> </h3></div>
            <div class="col-sm-4"><?php tribe_get_template_part( 'modules/meta/venue' ); ?></div>
            <div class="col-sm-8"><?php tribe_get_template_part( 'modules/meta/map' ); ?></div>
        </div>
    </div>
