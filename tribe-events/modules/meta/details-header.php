	...
	<div id="details-header" class="row">
	    <div class="col-sm-8">
	        <ul class="list-unstyled">
	            ...
	            <li><i class="fa fa-calendar-o fa-fw"></i> <abbr class="tribe-events-abbr updated published dtstart" title="<?php esc_attr_e( $start_ts ) ?>"> <?php esc_html_e( $start_date ) ?> </abbr> - <abbr class="tribe-events-abbr dtend" title="<?php esc_attr_e( $end_ts ) ?>"> <?php esc_html_e( $end_date ) ?> </abbr></li>
	        </ul>
	    </div>
	    <div id="tickets" class="col-sm-4">
            <ul class="list-unstyled">
                <?php if ( ! empty( $cost ) ) : ?>
                    <li><i class="fa fa-usd fa-fw"></i> <?php esc_html_e( $cost ); ?></li>
                <?php endif ?>
