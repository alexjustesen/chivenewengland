<?php
/**
 * The default template for displaying gallery content. Used for both single and index/archive/search.
 *
...
<?php // set post_type variable
    ...
    if( get_post_gallery() ) {
        ...
        $photo_count = count( explode( ',', $gallery['ids'] ) );
    }
?>
               ...
               <header>
                   ...
                   <div class="row entry-meta text-muted">
                        <div class="col-xs-6">
                            ...
                            <span class="block"><i class="fa fa-clock-o fa-fw"></i> <?php echo chivenewengland_entry_meta_dt(); ?></span>
                        </div>
                        ...
                        <div class="col-xs-6 text-right">
                            ...
                            <?php endif; ?>
                            <span class="block"><i class="fa fa-picture-o fa-fw"></i> <?php printf( __( '%s photos', 'chivenewengland' ), $photo_count ); ?></span>
                        </div>
                    </div>
               </header>
